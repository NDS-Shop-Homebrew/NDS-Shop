...
class Theme {
public:
	Theme(const std::string &ThemeJSON = "sdmc:/3ds/NDS-Shop/themes/Themes.json");
	nlohmann::json InitWithDefaultColors(const std::string &ThemePath = "sdmc:/3ds/NDS-Shop/themes/Themes.json");
